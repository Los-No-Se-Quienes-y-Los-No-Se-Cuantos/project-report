...
| HU11 | Creación de promociones | Como gerente, deseo poder crear promociones y ofertas especiales para atraer a más clientes y aumentar las ventas.                                                                        | **Dado que** el sistema cuenta con un módulo para administrar promociones, **Cuando** el gerente accede a la interfaz de creación de promociones, **Entonces** el sistema guarda la promoción en la base de datos y muestra la promoción en la interfaz de usuario para los clientes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | EPIC01  |
| HU12 | Registro de proveedores | Como gerente, deseo mantener un registro de los proveedores para gestionar eficientemente las relaciones comerciales y los suministros.                                                   | **Dado que** el sistema tiene un módulo para gestionar el registro de proveedores, **Cuando** el gerente accede a la interfaz de registro de proveedores, **Entonces** el sistema permite al gerente ingresar la información del proveedor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | EPIC01  |
