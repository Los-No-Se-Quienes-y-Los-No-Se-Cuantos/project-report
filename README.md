...
|----------|--------|-------------|--------------------------|---------|
| HU01 | Actualización de las habitaciones disponibles | Como gerente deseo un sistema que automáticamente cambie el estado de los dormitorios dependiendo si alguien la reservó o no para mantener actualizado su estado. | **Dado que** el sistema tiene información sobre las habitaciones, **Cuando** un usuario ingresa la información de una nueva habitación o modifica el estado de una habitación existente, **Entonces** el sistema valida la información ingresada y actualiza en la base de datos. | EPIC01 |
| HU02 | Asignamiento de tareas a empleados | Como gerente, deseo asignar tareas a los empleados para distribuir eficientemente las responsabilidades y mejorar la productividad. | **Dado que** el sistema tiene información sobre los empleados, **Cuando** un gerente selecciona un empleado y le asigna una tarea, **Entonces** el sistema asigna la tarea al empleado y se registra en la base de datos. El sistema envía una notificación al empleado sobre la tarea. | EPIC01 |
| HU03 | Notificaciones de baja en el inventario | Como gerente, deseo recibir notificaciones de baja en el inventario para tomar medidas rápidas en caso de escasez de suministros. | **Dado que** el sistema tiene información del inventario, **Cuando** el nivel de inventario de un artículo es bajo, **Entonces** el sistema envía una notificación al gerente con la información del artículo. | EPIC01 |
...
| HU19 | Reporte de problemas a la gerencia | Como empleado, deseo poder reportar problemas para comunicar a los gerentes del problema. | **Dado que** el sistema tiene un módulo para reportar problemas, **Cuando** un empleado observa un problema en el hotel, **Entonces** el sistema guarda el reporte del problema en la base de datos. | EPIC02 |
...
| HU23 | Inicio de Sesión en Front-End Application | Como developer, deseo mostrar iniciode sesión al usuario para tener información del usuario que accede al sistema. | **Dado que** se tiene acceso a la aplicación, **Cuando** el usuario ingresa su usuario y contraseña, **Entonces** el sistema verifica las credenciales ingresadas por el usuario. | EPIC03 |
...
| HU26 | Actualización del perfil de usuario | Como usuario, deseo actualizar mi perfil para mantener mi información personal actualizada. | **Dado que** el usuario tiene acceso a su perfil, **Cuando** el usuario edita su información personal y guarda los cambios, **Entonces** el sistema actualiza la información en la base de datos. | EPIC03 |
| HU27 | Recuperación de contraseña | Como usuario, deseo recuperar mi contraseña para poder acceder al sistema en caso de haberla olvidado. | **Dado que** el usuario ha olvidado su contraseña, **Cuando** el usuario solicita la recuperación de contraseña, **Entonces** el sistema envía un correo electrónico con las instrucciones para resetear la contraseña. | EPIC03 |
| HU28 | Reservar una habitación | Como usuario, deseo reservar una habitación para asegurar mi alojamiento en el hotel. | **Dado que** el usuario tiene acceso al sistema de reservas, **Cuando** el usuario selecciona una habitación disponible y confirma la reserva, **Entonces** el sistema guarda la reserva en la base de datos y envía una confirmación al usuario. | EPIC03 |
| HU29 | Cancelar una reserva | Como usuario, deseo cancelar una reserva para liberar la habitación y actualizar mi plan de viaje. | **Dado que** el usuario tiene una reserva activa, **Cuando** el usuario solicita la cancelación de la reserva, **Entonces** el sistema libera la habitación y actualiza la base de datos. | EPIC03 |
| HU30 | Ver historial de reservas | Como usuario, deseo ver el historial de mis reservas para revisar mis estadías pasadas en el hotel. | **Dado que** el usuario tiene una cuenta en el sistema, **Cuando** el usuario accede a su perfil y selecciona la opción de historial de reservas, **Entonces** el sistema muestra todas las reservas pasadas del usuario. | EPIC03 |
| HU31 | Realizar pago en línea | Como usuario, deseo realizar el pago de mi reserva en línea para confirmar mi estadía de manera conveniente. | **Dado que** el usuario tiene una reserva pendiente de pago, **Cuando** el usuario accede a la sección de pagos y proporciona los datos de su tarjeta, **Entonces** el sistema procesa el pago y envía una confirmación. | EPIC03 |
| HU32 | Solicitar servicios adicionales | Como usuario, deseo solicitar servicios adicionales durante mi estadía para mejorar mi experiencia en el hotel. | **Dado que** el usuario está registrado en el sistema, **Cuando** el usuario selecciona y solicita un servicio adicional, **Entonces** el sistema registra la solicitud y actualiza la factura del usuario. | EPIC03 |
| HU33 | Dejar un comentario | Como usuario, deseo dejar un comentario sobre mi experiencia en el hotel para compartir mi opinión y ayudar a mejorar los servicios. | **Dado que** el usuario ha completado su estadía, **Cuando** el usuario accede a la sección de comentarios y escribe su opinión, **Entonces** el sistema guarda el comentario en la base de datos. | EPIC03 |
| HU34 | Recibir notificaciones de promociones | Como usuario, deseo recibir notificaciones de promociones y ofertas especiales para aprovechar las mejores tarifas y servicios. | **Dado que** el usuario está registrado en el sistema, **Cuando** el hotel lanza una nueva promoción, **Entonces** el sistema envía una notificación al usuario. | EPIC03 |
| HU35 | Solicitar transporte | Como usuario, deseo solicitar un servicio de transporte desde y hacia el hotel para facilitar mi movilidad durante mi estadía. | **Dado que** el usuario tiene una reserva activa, **Cuando** el usuario solicita un servicio de transporte a través del sistema, **Entonces** el sistema registra la solicitud y coordina el transporte. | EPIC03 |
| HU36 | Visualizar mapa del hotel | Como usuario, deseo visualizar un mapa del hotel y sus alrededores para orientarme mejor durante mi estadía. | **Dado que** el usuario tiene acceso a la aplicación del hotel, **Cuando** el usuario selecciona la opción de mapa, **Entonces** el sistema muestra un mapa interactivo del hotel y sus alrededores. | EPIC03 |
| HU37 | Configurar preferencias de estadía | Como usuario, deseo configurar mis preferencias de estadía para personalizar mi experiencia en el hotel. | **Dado que** el usuario está registrado en el sistema, **Cuando** el usuario accede a la sección de preferencias y guarda sus opciones, **Entonces** el sistema actualiza el perfil del usuario con las preferencias seleccionadas. | EPIC03 |
| HU38 | Solicitar limpieza de habitación | Como usuario, deseo solicitar la limpieza de mi habitación para mantenerla en condiciones óptimas durante mi estadía. | **Dado que** el usuario tiene una reserva activa, **Cuando** el usuario solicita la limpieza a través del sistema, **Entonces** el sistema registra la solicitud y notifica al personal de limpieza. | EPIC03 |
| HU39 | Solicitar check-out tardío | Como usuario, deseo solicitar un check-out tardío para extender mi estadía en el hotel. | **Dado que** el usuario tiene una reserva activa, **Cuando** el usuario solicita un check-out tardío a través del sistema, **Entonces** el sistema verifica la disponibilidad y confirma la solicitud si es posible. | EPIC03 |
| HU40 | Solicitar desayuno en la habitación | Como usuario, deseo solicitar el servicio de desayuno en la habitación para disfrutar de mayor comodidad durante mi estadía. | **Dado que** el usuario tiene una reserva activa, **Cuando** el usuario solicita el servicio de desayuno a través del sistema, **Entonces** el sistema registra la solicitud y notifica al personal de cocina. | EPIC03 |
| HU41 | Verificar estado de la habitación | Como empleado, deseo verificar el estado de una habitación para asegurarme de que esté lista para recibir a nuevos huéspedes. | **Dado que** el sistema tiene información sobre el estado de las habitaciones, **Cuando** un empleado accede a la interfaz de estado de habitaciones, **Entonces** el sistema muestra el estado actual de cada habitación. | EPIC02 |
| HU42 | Gestionar solicitudes de los huéspedes | Como empleado, deseo gestionar las solicitudes de los huéspedes para atender sus necesidades de manera eficiente. | **Dado que** el sistema tiene información sobre las solicitudes de los huéspedes, **Cuando** un empleado accede a la lista de solicitudes, **Entonces** el sistema permite al empleado marcar las solicitudes como completadas o en proceso. | EPIC02 |
| HU43 | Administrar reservas grupales | Como empleado, deseo administrar reservas grupales para coordinar mejor la asignación de habitaciones y servicios. | **Dado que** el sistema permite la creación de reservas grupales, **Cuando** un empleado accede a la interfaz de reservas grupales, **Entonces** el sistema muestra todas las reservas grupales y permite gestionarlas. | EPIC02 |
| HU44 | Gestionar horarios de limpieza | Como empleado, deseo gestionar los horarios de limpieza de las habitaciones para mantener el hotel en condiciones óptimas. | **Dado que** el sistema tiene información sobre las habitaciones y el personal de limpieza, **Cuando** un empleado accede a la interfaz de horarios de limpieza, **Entonces** el sistema permite al empleado asignar y modificar los horarios de limpieza. | EPIC02 |
| HU45 | Reportar incidentes de seguridad | Como empleado, deseo reportar incidentes de seguridad para garantizar la seguridad de los huéspedes y el personal. | **Dado que** el sistema tiene un módulo para reportar incidentes, **Cuando** un empleado observa un incidente de seguridad, **Entonces** el sistema guarda el reporte del incidente en la base de datos y notifica al personal de seguridad. | EPIC02 |
| HU46 | Administrar inventario de suministros | Como empleado, deseo administrar el inventario de suministros para asegurar que siempre haya suficiente material disponible. | **Dado que** el sistema tiene información sobre el inventario de suministros, **Cuando** un empleado accede a la interfaz de inventario, **Entonces** el sistema permite al empleado actualizar el nivel de inventario y registrar nuevas entradas de suministros. | EPIC02 |
| HU47 | Ver calendario de eventos | Como empleado, deseo ver el calendario de eventos del hotel para coordinar mis actividades y tareas. | **Dado que** el sistema tiene información sobre los eventos del hotel, **Cuando** un empleado accede al calendario de eventos, **Entonces** el sistema muestra todos los eventos programados y sus detalles. | EPIC02 |
| HU48 | Asignar habitaciones a huéspedes | Como empleado, deseo asignar habitaciones a los huéspedes para organizar sus estadías de manera eficiente. | **Dado que** el sistema tiene información sobre las reservas y disponibilidad de habitaciones, **Cuando** un huésped realiza el check-in, **Entonces** el sistema asigna una habitación disponible al huésped y actualiza la base de datos. | EPIC02 |
| HU49 | Generar reportes de ocupación | Como gerente, deseo generar reportes de ocupación para analizar la tasa de ocupación del hotel y planificar estrategias de mejora. | **Dado que** el sistema tiene información sobre las reservas y la ocupación de habitaciones, **Cuando** el gerente solicita un reporte de ocupación, **Entonces** el sistema genera un reporte con la tasa de ocupación y otros detalles relevantes. | EPIC01 |
| HU50 | Gestionar tarifas de habitaciones| Como gerente, deseo gestionar las tarifas de las habitaciones para optimizar los ingresos del hotel. | **Dado que** el sistema permite la configuración de tarifas, **Cuando** el gerente accede a la interfaz de tarifas, **Entonces** el sistema permite al gerente ajustar las tarifas según la demanda y otras variables. | EPIC01 |
| HU51 | Analizar comentarios de huéspedes | Como gerente, deseo analizar los comentarios de los huéspedes para identificar áreas de mejora en los servicios del hotel. | **Dado que** el sistema guarda los comentarios de los huéspedes, **Cuando** el gerente accede a la sección de comentarios, **Entonces** el sistema muestra un análisis de los comentarios con tendencias y áreas de mejora. | EPIC01 |
| HU52 | Monitorear el desempeño del personal | Como gerente, deseo monitorear el desempeño del personal para asegurar que se mantengan los estándares de calidad en el hotel. | **Dado que** el sistema tiene información sobre las actividades y tareas del personal, **Cuando** el gerente accede a la interfaz de desempeño del personal, **Entonces** el sistema muestra métricas y reportes sobre el desempeño de cada empleado. | EPIC01 |
| HU53 | Configurar políticas del hotel | Como gerente, deseo configurar las políticas del hotel para asegurar el cumplimiento de normas y regulaciones. | **Dado que** el sistema permite la configuración de políticas, **Cuando** el gerente accede a la interfaz de configuración, **Entonces** el sistema permite al gerente definir y modificar las políticas del hotel. | EPIC01 |
| HU54 | Implementar promociones especiales | Como gerente, deseo implementar promociones especiales para aumentar la ocupación y atraer más huéspedes. | **Dado que** el sistema permite la configuración de promociones, **Cuando** el gerente accede a la interfaz de promociones, **Entonces** el sistema permite al gerente crear y gestionar promociones especiales. | EPIC01 |
| HU55 | Ver reportes financieros | Como gerente, deseo ver reportes financieros del hotel para evaluar el desempeño económico y tomar decisiones informadas. | **Dado que** el sistema tiene información financiera del hotel, **Cuando** el gerente accede a la sección de reportes financieros, **Entonces** el sistema muestra un reporte detallado con ingresos, gastos y otras métricas financieras. | EPIC01 |
| HU56 | Administrar roles y permisos | Como gerente, deseo administrar los roles y permisos de los empleados para controlar el acceso a diferentes funciones del sistema. | **Dado que** el sistema permite la gestión de roles y permisos, **Cuando** el gerente accede a la interfaz de roles y permisos, **Entonces** el sistema permite al gerente asignar y modificar los permisos de cada empleado. | EPIC01 |
